    ...
    return (
        ...
        >
            <div class={`card-inner ${Flip ? 'cardRotate' : null}`}>
                ...
                <div class="card-front p-4">
                    <div className="w-full h-full flex flex-col items-center mt-4">
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center mt-4">
                            {/* MEMBER POSITION */}
                            <h1 className='bg-clip-text text-transparent bg-gradient-to-b from-[#E64467] to-[#7E5CC5] font-bold text-2xl text-center'>{currentPosition}</h1>
                            {/* MEMBER NAME */}
                ...
                {/* CARD BACK SIDE */}
                <div class="card-back p-4 flex-col">
