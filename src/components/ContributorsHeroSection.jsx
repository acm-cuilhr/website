		...
		<section className='h-[70vh] lg:h-screen bg-[url("/assets/GallerybgImg.png")] bg-no-repeat bg-cover bg-center flex flex-col items-center px-5 md:px-10 lg:px-0'>
			<motion.div
				...
				<div className="flex items-center flex-col">
					...
					<h1 className="text-[42px] md:text-[90px] lg:text-[158px] font-semibold leading-none bg-clip-text text-transparent bg-gradient-to-r from-[#56B4F0] via-[#F9C0CF] to-[#8B9BEC]">
						CONTRIBUTORS
					</h1>
				</div>
