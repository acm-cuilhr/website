    ...
    return (
        <section className='h-[80vh] lg:h-screen bg-[url("./assets/Effectherosection.png")] bg-no-repeat bg-cover bg-center px-5 md:px-10 lg:px-0'>
            ...
            >
                ...
                {/* ACM HEADING */}
                <h1 className='text-[100px] md:text-[178px] font-semibold leading-none bg-clip-text text-transparent bg-gradient-to-r from-[#56B4F0] via-[#F9C0CF] to-[#8B9BEC] mt-[18vh] md:mt-[20vh]'>ACM</h1>
