		...
		<section className="bg-[#1B1622] px-5 py-14 md:px-10 md:py-[80px] lg:px-[120px] lg:py-[120px] flex justify-center items-center">
			<div className="flex flex-col w-full xl:w-[1300px]">
				...
				<div className="flex flex-col mt-10 lg:mt-0">
					<motion.h1
						className="font-poppins text-[32px] md:text-[48px] font-bold text-center lg:text-start text-white"
						initial={{ x: -100, opacity: 0 }}
						whileInView={{ x: 0, opacity: 1 }}
						transition={{ type: "spring" }}>
						Get in Touch with our{" "}
						<span className="bg-clip-text text-transparent bg-gradient-to-b from-[#D471F4] to-[#6F20CE]">
							Team
						</span>
						.
					</motion.h1>
				...
				<div className="w-full flex flex-col-reverse lg:flex-row lg:justify-between mt-14">
					...
					<div className="flex flex-col w-full mt-5 lg:mt-0 lg:w-[48%]">
						...
						<div className="w-full flex justify-start mt-4">
							<button
								className={`rounded-full w-[140px] md:w-[160px] h-10 md:h-12 ml-1 bg-gradient-to-r from-[#F087FF] via-[#6E1FCE] to-[#6E1FCE33] text-white ${
									disableButton
										? "opacity-50"
										: "hover:shadow-[0_0_15px_2px_#F087FF]"
								}`}
					...
					{/* IMAGE */}
					<motion.div
						className="w-full lg:w-[48%] h-[400px] overflow-hidden rounded-xl relative"
						initial={{ scale: 0 }}
						whileInView={{ scale: 1 }}
						transition={{ type: "spring" }}>
						<img
							className="w-full h-full object-cover"
							src="/assets/contact-form-img.png"
							alt=""
						/>
						<div className="absolute bottom-10 px-10 w-full flex justify-center items-center">
							<span className="text-center text-2xl font-bold text-white">
								“Transforming the technical into thrilling adventures”
							</span>
						</div>
					</motion.div>
				</div>
