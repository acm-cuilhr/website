...
const TestimonialSection = (props) => {
	...
	return (
		<section className="bg-black p-5 py-10 md:py-[80px] lg:py-[80px] flex justify-center items-center">
			<div className="flex flex-col mt-10 lg:mt-0">
				...
				<motion.div
					...
					<h1 className="text-white text-[32px] md:text-[48px] font-bold font-poppins text-center lg:text-start">
						Words from Our
					</h1>
					<h1 className="text-white text-[32px] md:text-[48px] font-bold font-poppins flex flex-col lg:flex-row lg:mt-[-15px] text-center lg:text-start">
						<span className="bg-clip-text text-transparent bg-gradient-to-b from-[#E64467] to-[#7E5CC5]">
							Pioneers.
						</span>
					</h1>
				</motion.div>
				...
				{/* TESTIMONIAL CARDS */}
				<div className="w-full flex flex-wrap flex-row gap-4 items-center justify-center">
