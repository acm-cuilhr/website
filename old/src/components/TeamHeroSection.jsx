...
export default function TeamHeroSection() {
	return (
		<section className='h-screen bg-[url("/assets/GallerybgImg.png")] bg-no-repeat bg-cover bg-center flex flex-col items-center px-5 md:px-10 lg:px-0'>
			<motion.div
				className="mt-[15vh] md:mt-[25vh]"
				initial={{ scale: 0 }}
				whileInView={{ scale: 1 }}
				transition={{ type: "spring", duration: 0.8 }}>
				{/* ACM HEADING */}
				<div className="flex items-center flex-col lg:flex-row">
					<h1 className="text-[100px] md:text-[178px] font-semibold leading-none bg-clip-text text-transparent bg-gradient-to-r from-[#56B4F0] via-[#F9C0CF] to-[#8B9BEC]">
						MEET
					</h1>
